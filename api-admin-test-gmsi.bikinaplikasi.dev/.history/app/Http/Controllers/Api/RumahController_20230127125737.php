...
class RumahController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('gambar2')) {
            $requestData['gambar2'] = str_replace("\\", "/", $request->file('gambar2')
                ->move('uploads', time() . "." . $request->file('gambar2')->getClientOriginalExtension()));
        }

        if ($request->hasFile('gambar3')) {
            $requestData['gambar3'] = str_replace("\\", "/", $request->file('gambar3')
                ->move('uploads', time() . "." . $request->file('gambar3')->getClientOriginalExtension()));
        }

        if ($request->hasFile('gambar4')) {
            $requestData['gambar4'] = str_replace("\\", "/", $request->file('gambar4')
                ->move('uploads', time() . "." . $request->file('gambar4')->getClientOriginalExtension()));
        }

        if ($request->hasFile('gambar5')) {
            $requestData['gambar5'] = str_replace("\\", "/", $request->file('gambar5')
                ->move('uploads', time() . "." . $request->file('gambar5')->getClientOriginalExtension()));
        }
    ...
    public function update(Request $request, Rumah $rumah)
    {
        ...
        if ($request->hasFile('gambar1')) {
            $requestData['gambar1'] = str_replace("\\", "/", $request->file('gambar1')
                ->move('uploads', time() . "." . $request->file('gambar1')->getClientOriginalExtension()));
